        ...
        <SectionContent className="relative z-10 text-center max-w-5xl mx-auto px-6 py-16">
          ...
          <div className="space-y-4 mb-12">
            <p className="text-lg sm:text-xl text-muted-foreground/80">
              Information Management X Trans-disciplinary Student at NTU
            </p>
          </div>
          ...
          <div className="flex justify-center gap-6">
            ...
            <a href="https://medium.com/@wliu5928" target="_blank" rel="noopener noreferrer" className="group p-3 rounded-full border border-border/50 hover:border-foreground/20 bg-background/50 backdrop-blur-sm hover:shadow-lg transition-all duration-300 hover:scale-110">
              <svg className="w-6 h-6 text-muted-foreground group-hover:text-foreground transition-colors" fill="currentColor" viewBox="0 0 24 24">
